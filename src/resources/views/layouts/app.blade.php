...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .header-inner { max-width: 1100px; margin: 0 auto; padding: 16px; display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap; }
        ...
        input[type=text], input[type=email], input[type=password], input[type=time], textarea { width: 100%; max-width: 420px; padding: 10px 12px; border: 1px solid var(--border); border-radius: 6px; }
